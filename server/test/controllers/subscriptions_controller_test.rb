...
class SubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription" do
    assert_difference('Subscription.count') do
      post subscriptions_url, params: { subscription: { name: @subscription.name, zuora_id: @subscription.zuora_id } }
    end
  ...
  test "should update subscription" do
    patch subscription_url(@subscription), params: { subscription: { name: @subscription.name, zuora_id: @subscription.zuora_id } }
